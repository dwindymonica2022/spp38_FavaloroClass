...
if( empty( $_SESSION['iduser'] ) ){
	...
	if( isset( $_REQUEST['aksi'] )){
		...
		$sql = mysqli_query($konek, "SELECT kelas.kelas, kelas.th_pelajaran, count(kelas.nis) as jml, santri.idbalai FROM kelas,santri WHERE kelas.nis=santri.nis AND th_pelajaran='2016/2017' GROUP BY kelas.kelas");
